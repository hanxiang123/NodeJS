- [Node.js （最全）基础+全栈项目](#nodejs-最全基础全栈项目)
  - [一、Node.js基础](#一nodejs基础)
    - [1.认识Node.js](#1认识nodejs)
      - [01 nodejs的特性](#01-nodejs的特性)
      - [02 使用 Node.js 需要了解多少 JavaScript](#02-使用-nodejs-需要了解多少-javascript)
      - [03 浏览器环境vs node环境](#03-浏览器环境vs-node环境)
    - [2.开发环境搭建](#2开发环境搭建)
    - [3.模块、包、commonJS](#3模块包commonjs)
      - [02 CommonJS规范](#02-commonjs规范)
      - [03 modules模块化规范写法](#03-modules模块化规范写法)
    - [4.Npm \& Yarn](#4npm--yarn)
      - [01 npm的使用](#01-npm的使用)
      - [02 全局安装 nrm](#02-全局安装-nrm)
      - [03 yarn使用](#03-yarn使用)
    - [5.内置模块](#5内置模块)
      - [01 http模块](#01-http模块)
      - [02 url模块](#02-url模块)
      - [03 querystring模块](#03-querystring模块)
      - [04 http模块补充](#04-http模块补充)
      - [05 event模块](#05-event模块)
      - [06 fs文件操作模块](#06-fs文件操作模块)
      - [07 stream流模块](#07-stream流模块)
      - [08 zlib](#08-zlib)
      - [09 crypto](#09-crypto)
    - [6.路由](#6路由)
      - [01 基础](#01-基础)
  ...
  - [二、Express](#二express)
    ...
    - [4.中间件](#4中间件)
      ...
      - [（5）第三方中间件](#5第三方中间件)
    - [5.获取请求参数](#5获取请求参数)
    - [6.利用 Express 托管静态文件](#6利用-express-托管静态文件)
    - [7.服务端渲染（模板引擎）](#7服务端渲染模板引擎)
  - [三、MongoDB](#三mongodb)
    - [1.关系型与非关系型数据库](#1关系型与非关系型数据库)
    - [2.安装数据库](#2安装数据库)
    - [3.启动数据库](#3启动数据库)
      - [（1）windows](#1windows)
      - [（2）mac](#2mac)
    - [4.在命令行中操作数据库](#4在命令行中操作数据库)
    - [5.可视化工具进行增删改查](#5可视化工具进行增删改查)
    - [6.nodejs连接操作数据库](#6nodejs连接操作数据库)
  - [四、接口规范与业务分层](#四接口规范与业务分层)
    - [1.接口规范](#1接口规范)
    - [2.业务分层](#2业务分层)
  - [五、登录鉴权](#五登录鉴权)
    - [1.Cookie\&Session](#1cookiesession)
    - [2.JSON Web Token (JWT)](#2json-web-token-jwt)
      - [（1）介绍](#1介绍)
      - [（2）实现](#2实现)
  - [六、文件上传管理](#六文件上传管理)
  - [七、APIDOC - API 文档生成工具](#七apidoc---api-文档生成工具)
  - [八、Koa2](#八koa2)
    - [1.简介](#1简介)
    - [2.快速开始](#2快速开始)
      - [2.1 安装koa2](#21-安装koa2)
      - [2.2 hello world 代码](#22-hello-world-代码)
      - [2.3 启动demo](#23-启动demo)
    - [3.koa vs express](#3koa-vs-express)
      - [3.1 更轻量](#31-更轻量)
      - [3.2 Context对象](#32-context对象)
      - [3.3 异步流程控制](#33-异步流程控制)
      - [3.4 中间件模型](#34-中间件模型)
    - [4.路由](#4路由)
      - [4.1基本用发](#41基本用发)
      - [4.2 router.allowedMethods作用](#42-routerallowedmethods作用)
      - [4.3 请求方式](#43-请求方式)
      - [4.4 拆分路由](#44-拆分路由)
      - [4.5 路由前缀](#45-路由前缀)
      - [4.6 路由重定向](#46-路由重定向)
    ...
    - [6.获取请求参数](#6获取请求参数)
      - [6.1 get参数](#61-get参数)
      - [6.2 post参数](#62-post参数)
    - [7.ejs模板](#7ejs模板)
      - [7.1 安装模块](#71-安装模块)
      - [7.2 使用模板引擎](#72-使用模板引擎)
    - [8.cookie\&session](#8cookiesession)
      - [8.1 cookie](#81-cookie)
      - [8.2 session](#82-session)
    - [9.JWT](#9jwt)
    - [10.上传文件](#10上传文件)
    - [11.操作MongoDB](#11操作mongodb)
  - [九、MySQL](#九mysql)
    - [1.介绍](#1介绍-1)
    - [2.与非关系数据库区别](#2与非关系数据库区别)
    - [3.sql语句](#3sql语句)
    - [4.nodejs 操作数据库](#4nodejs-操作数据库)
  - [十、Socket编程](#十socket编程)
    - [1.websocket介绍](#1websocket介绍)
    - [2.ws模块](#2ws模块)
    - [3.socket.io模块](#3socketio模块)
  - [十一、mocha](#十一mocha)
    - [1.编写测试](#1编写测试)
    - [2.chai断言库](#2chai断言库)
    - [3.异步测试](#3异步测试)
